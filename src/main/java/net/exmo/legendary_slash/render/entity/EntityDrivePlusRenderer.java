...
@OnlyIn(Dist.CLIENT)
public class EntityDrivePlusRenderer<T extends EntityDrivePlus> extends EntityRenderer<T> {
    ...
    public EntityDrivePlusRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
