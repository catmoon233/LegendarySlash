package net.exmo.legendary_slash.render.entity;
...
@OnlyIn(Dist.CLIENT)
public class SummonedSwordPlusRenderer<T extends SummonedSwordPlus> extends EntityRenderer<T> {
    ...
    public SummonedSwordPlusRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
