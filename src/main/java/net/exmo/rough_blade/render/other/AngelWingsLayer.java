...
public class AngelWingsLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    private static final ResourceLocation WINGS_LOCATION = new ResourceLocation(Rough_blade.MODID, "textures/entity/angel_wings.png");
    ...
    public boolean shouldRender(T entity) {
        ...
        return entity.hasEffect(Rough_blade.effectAbout.ArmorStart.get());
    }
