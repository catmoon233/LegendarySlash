...
public class FaZhenUnder extends Projectile {
    ...
    static {
        RX = SynchedEntityData.defineId(FaZhenUnder.class, EntityDataSerializers.FLOAT);
        RY = SynchedEntityData.defineId(FaZhenUnder.class, EntityDataSerializers.FLOAT);
        COLOR = SynchedEntityData.defineId(FaZhenUnder.class, EntityDataSerializers.INT);
    }
    public int getColor() {
    ...
    public static final EntityDataAccessor<Integer> TICK = SynchedEntityData.defineId(FaZhenUnder.class, EntityDataSerializers.INT); ;
    public FaZhenUnder(EntityType<? extends Projectile> entityTypeIn, Level worldIn) {
        super(entityTypeIn, worldIn);
        this.noCulling=true;
    }
    public static FaZhenUnder createInstance(PlayMessages.SpawnEntity packet, Level worldIn) {
        return new FaZhenUnder(RBEntityRegistry.FZU, worldIn);
    }
